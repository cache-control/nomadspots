...
| map(
    {
        ...
        fee:
            (
                if (.RecAreaFeeDescription // ""|test("No Fee|None|Free"; "i")) then
                    "Free"
                else
                    "Unknown"
                end
